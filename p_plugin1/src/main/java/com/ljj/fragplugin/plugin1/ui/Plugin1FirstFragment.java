...
public class Plugin1FirstFragment extends PluginFragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle
        ...
        TextView titleTextView = (TextView) rootView.findViewById(R.id.plugin1_title);
        TextView appcommTextView = (TextView) rootView.findViewById(R.id.plugin1_appcomm);
        TextView resourceTextView = (TextView) rootView.findViewById(R.id.plugin1_resource);
        rootView.findViewById(R.id.plugin1_nextpage).setOnClickListener(this);

        //TODO 引用插件的资源，需要使用插件的resource
        titleTextView.setText(getPluginResources().getString(R.string.plugin1_string));
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.plugin1_nextpage){
            openPage(Plugin1SecondFragment.class.getSimpleName(),null, CoreAnim.slide,true,false);
        }
    }
}
